...
public class L4_NextLevel : MonoBehaviour
{
    ...
    private void changeScene()
    {
        ...
        if (ScoreScript.PlayerScore >= thresholdScoree && L4_Timer.TimeValue > 0)
        {
