...
public class L5_NextLevel : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        pc = GameObject.FindGameObjectWithTag("Player").GetComponent<L5_PlayerController>();
    ...
    private void changeScene()
    {
        ...
        if (ScoreScript.PlayerScore >= thresholdScoree && L5_Timer.TimeValue > 0)
        {
            ...
            loadScene = true;
            resetValues();
            SceneManager.LoadScene("LevelScenes/CompleteLevel5");
        }
