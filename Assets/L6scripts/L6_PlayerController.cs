...
public class L6_PlayerController : MonoBehaviour
{
    ...
    public L6_NextLevel nextLevelScript;
    ...
    void Start()
    {
        ...
        nextLevelScript = GameObject.FindGameObjectWithTag("NextLevelManager").GetComponent<L6_NextLevel>();
