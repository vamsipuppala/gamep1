...
public class L12_NextLevel : MonoBehaviour
{
    ...
    public L12_PlayerController pc;
    ...
    private void Start()
    {
        ...
        pc = GameObject.FindGameObjectWithTag("Player").GetComponent<L12_PlayerController>();
    ...
    private void changeScene()
    {
        ...
        if (ScoreScript.PlayerScore >= thresholdScoree && L12_Timer.TimeValue > 0)
        {
            ...
            loadScene = true;
            resetValues();
            SceneManager.LoadScene("LevelScenes/CompleteLevel12");
        }
