...
public class L12_PlayerController : MonoBehaviour
{
    ...
    public L12_NextLevel nextLevelScript;
    ...
    void Start()
    {
        ...
        nextLevelScript = GameObject.FindGameObjectWithTag("NextLevelManager").GetComponent<L12_NextLevel>();
