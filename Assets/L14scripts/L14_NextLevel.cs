...
public class L14_NextLevel : MonoBehaviour
{
    ...
    public L14_PlayerController pc;
    ...
    private void Start()
    {
        ...
        pc = GameObject.FindGameObjectWithTag("Player").GetComponent<L14_PlayerController>();
    ...
    private void changeScene()
    {
        ...
        if (ScoreScript.PlayerScore >= thresholdScoree && L14_Timer.TimeValue > 0)
        {
            ...
            loadScene = true;
            resetValues();
            SceneManager.LoadScene("LevelScenes/CompleteLevel14");
        }
