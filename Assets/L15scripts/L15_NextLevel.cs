...
public class L15_NextLevel : MonoBehaviour
{
    ...
    public L15_PlayerController pc;
    ...
    private void Start()
    {
        ...
        pc = GameObject.FindGameObjectWithTag("Player").GetComponent<L15_PlayerController>();
    ...
    private void changeScene()
    {
        ...
        if (ScoreScript.PlayerScore >= thresholdScoree && L15_Timer.TimeValue > 0)
        {
            ...
            loadScene = true;
            resetValues();
            SceneManager.LoadScene("LevelScenes/CompleteLevel15");
        }
