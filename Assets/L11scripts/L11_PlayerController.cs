...
public class L11_PlayerController : MonoBehaviour
{
   ...
   public float hinderence_stop_time ;
    ...
    public L11_NextLevel nextLevelScript;
    ...
    void Start()
    {
        ...
        nextLevelScript = GameObject.FindGameObjectWithTag("NextLevelManager").GetComponent<L11_NextLevel>();
