...
public class L13_NextLevel : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        pc = GameObject.FindGameObjectWithTag("Player").GetComponent<L13_PlayerController>();
    ...
    private void changeScene()
    {
        ...
        if (ScoreScript.PlayerScore >= thresholdScoree && L13_Timer.TimeValue > 0)
        {
            ...
            loadScene = true;
            resetValues();
            SceneManager.LoadScene("LevelScenes/CompleteLevel13");
        }
